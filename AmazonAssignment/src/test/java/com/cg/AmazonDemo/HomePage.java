...
public class HomePage {
	...
	@FindBy(how=How.XPATH,using="//*[@id=\"nav-search\"]/form/div[2]/div/input")
	  WebElement accept;
	@FindBy(how=How.XPATH,using="//*[@id=\"result_8\"]/div/div/div/div[2]/div[1]/div[1]/a/h2")
	 WebElement navigation;
	@FindBy(how=How.XPATH,using="//*[@id=\"add-to-cart-button\"]")
	 WebElement navigationto;
	
	@FindBy(how=How.XPATH,using="//*[@id=\"huc-v2-order-row-confirm-text\"]/h1")
	 WebElement geth1;
	@FindBy(how=How.XPATH,using="//*[@id=\"result_10\"]/div/div[3]/div[1]/a/h2")
	 WebElement sg;
	@FindBy(how=How.XPATH,using="//*[@id=\"result_1\"]/div/div[3]/div[1]/a/h2")
	WebElement note4;
	@FindBy(how=How.XPATH,using="//*[@id=\"result_3\"]/div/div[3]/div[1]/a/h2")
	WebElement watch;
	@FindBy(how=How.XPATH,using="//*[@id=\"result_6\"]/div/div/div/div[2]/div[1]/div[1]/a/h2")
	WebElement iphone10;
